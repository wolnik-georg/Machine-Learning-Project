...
BASE_CHANNELS = 96
BATCH_SIZE = 8
CHECKPOINT = '/home/pml17/Machine-Learning-Project/trained_models/timm_swin_tiny_patch4_window7_224.pth'
...
RUN_NAME = 'cascade_mask_rcnn_swin_tiny'
...
backbone = dict(
    ...
    init_cfg=dict(
        checkpoint=
        '/home/pml17/Machine-Learning-Project/trained_models/timm_swin_tiny_patch4_window7_224.pth',
        type='Pretrained'),
    mlp_ratio=4.0,
    num_heads=[
        3,
...
work_dir = '/home/pml17/Machine-Learning-Project/runs/cascade_mask_rcnn_swin_tiny_fpn_coco'
