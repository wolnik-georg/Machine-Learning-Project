...
SWIN_CONFIG = {
    ...
    "use_relative_bias": False,  # Ablation flag: True for learned bias, False for zero bias
    "use_absolute_pos_embed": True,  # Ablation flag: True for absolute pos embed (ViT-style), False for relative bias. Can be combined with use_relative_bias=True for hybrid approach
